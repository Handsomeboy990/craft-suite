...
Craft Suite: 157 skills and 18 agents, in eight trees. Named
...
| `agents/` | 18 role definitions, repository wide | none, defined once per role |
...
3. Skill language is English, for all 157 skills and all 18 agents. Output
