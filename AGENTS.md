...
Craft Suite: 165 skills and 22 agents, in eight trees. Named
...
| `engineering/` | 81 software skills | `engineering/dev-skills/engineering-core` and `engineering/devops-skills/devops-core` |
| `agents/` | 22 role definitions, repository wide | none, defined once per role |
...
3. Skill language is English, for all 165 skills and all 22 agents. Output
