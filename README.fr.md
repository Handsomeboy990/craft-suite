...
**Le métier, encodé.** 155 skills et 16 agents qui tiennent un agent à un
...
| `craft-engineering` | une équipe de livraison, de la spécification à la production | 73 et 16 agents |
...
| Les 16 agents | [documentation/agents.md](documentation/agents.md) |
