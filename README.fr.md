...
**Le métier, encodé.** 166 skills et 22 agents qui tiennent un agent à un
...
bash install.sh --all        # ou prenez les 166 et les 22 agents
...
| `craft-engineering` | une équipe de livraison, de la spécification à la production | 82 et 22 agents |
