...
**Le métier, encodé.** 165 skills et 21 agents qui tiennent un agent à un
...
bash install.sh --all        # ou prenez les 165 et les 21 agents
...
| `craft-engineering` | une équipe de livraison, de la spécification à la production | 81 et 21 agents |
...
| Les 21 agents | [documentation/agents.md](documentation/agents.md) |
