...
**Le métier, encodé.** 159 skills et 19 agents qui tiennent un agent à un
...
bash install.sh --all        # ou prenez les 159 et les 19 agents
...
| `craft-engineering` | une équipe de livraison, de la spécification à la production | 76 et 19 agents |
