...
**Le métier, encodé.** 163 skills et 21 agents qui tiennent un agent à un
...
bash install.sh --all        # ou prenez les 163 et les 21 agents
...
| `craft-engineering` | une équipe de livraison, de la spécification à la production | 79 et 21 agents |
