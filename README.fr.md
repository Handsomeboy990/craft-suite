...
**Le métier, encodé.** 165 skills et 22 agents qui tiennent un agent à un
...
bash install.sh --all        # ou prenez les 165 et les 22 agents
...
| `craft-engineering` | une équipe de livraison, de la spécification à la production | 81 et 22 agents |
...
| Les 22 agents | [documentation/agents.md](documentation/agents.md) |
