...
**Craft, encoded.** 158 skills and 19 agents that hold an agent to a
...
bash install.sh --all        # or take all 158 and the 19 agents
...
| `craft-engineering` | a delivery team, from specification to production | 75 and 19 agents |
...
| The 19 agents | [documentation/agents.md](documentation/agents.md) |
