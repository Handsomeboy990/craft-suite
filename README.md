...
**Craft, encoded.** 159 skills and 19 agents that hold an agent to a
...
bash install.sh --all        # or take all 159 and the 19 agents
...
| `craft-engineering` | a delivery team, from specification to production | 76 and 19 agents |
