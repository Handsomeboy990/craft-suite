...
**Craft, encoded.** 160 skills and 21 agents that hold an agent to a
...
bash install.sh --all        # or take all 160 and the 21 agents
...
| `craft-engineering` | a delivery team, from specification to production | 77 and 21 agents |
