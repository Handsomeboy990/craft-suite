...
**Craft, encoded.** 163 skills and 21 agents that hold an agent to a
...
bash install.sh --all        # or take all 163 and the 21 agents
...
| `craft-engineering` | a delivery team, from specification to production | 79 and 21 agents |
