...
// The quotation form posts to the site's own endpoint, which stores the request
// and shows it in the back office. A form that posts into nothing is the most
// common broken thing on a client site, and on this one it is the business.
