...
Software engineering and project delivery. 74 skills in three categories, plus
...
|---|---|---|
| [dev-skills](dev-skills/) | 50 | how a change is made correctly |
...
```bash
bash install.sh --dev         the 74 engineering skills and the 17 agents
