...
Software engineering and project delivery. 77 skills in three categories, plus
...
|---|---|---|
| [dev-skills](dev-skills/) | 52 | how a change is made correctly |
...
```bash
bash install.sh --dev         the 77 engineering skills and the 21 agents
