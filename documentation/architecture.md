...
The Craft Suite is a library of 160 skills in eighteen groups across
eight trees, plus twenty-one agents, shared resources, the configuration contract,
...
| Layer | Value |
|---|---|
| Skill language | English, all 160 skills and all 21 agents |
