...
eight trees, plus twenty-six agents, shared resources, the configuration contract,
...
| Layer | Value |
|---|---|
| Skill language | English, all 167 skills and all 26 agents |
