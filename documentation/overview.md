...
156 skills and 17 agents. Not prompts: numbered protocols, decision criteria,
...
├── engineering/     74 software skills
...
|---|---|---|
| Skill language | the instructions themselves | English, all 156 skills |
...
than assuming its shape. The seventeen agents are not a category of this tree:
...
```
   ...
   3) Software engineering    74 skills   plus 17 agents
   ...
   8) Everything             156 skills   plus 17 agents
...
bash install.sh --dev          74 engineering skills and 17 agents
...
bash install.sh --agents        the 17 agents only
...
Seventeen role definitions, for a runtime that supports subagents.
...
| `craft-engineering` | the engineering tree, 74 skills and 17 agents |
...
```bash
bash tests/validate-structure.sh      structure and metadata of 156 skills
...
| [documentation/skills-guide.md](skills-guide.md) | directory of the 156 skills |
