...
165 skills et 21 agents. Pas des prompts : des protocoles numérotés, des
...
```
   ...
   3) Software engineering    81 skills   plus 21 agents
   ...
   8) Everything             165 skills   plus 21 agents
...
bash install.sh --dev          les 81 skills d'ingénierie et les 21 agents
...
| `craft-engineering` | l'arbre d'ingénierie, 81 skills et 21 agents |
