...
155 skills et 16 agents. Pas des prompts : des protocoles numérotés, des
...
├── engineering/     73 skills d'ingénierie
...
|---|---|---|
| Langue des skills | les instructions elles-mêmes | anglais, pour les 155 skills |
...
bash install.sh --dev          les 73 skills d'ingénierie et les 16 agents
...
| `craft-engineering` | l'arbre d'ingénierie, 73 skills et 16 agents |
...
```bash
bash tests/validate-structure.sh      structure et métadonnées des 155 skills
...
| [documentation/skills-guide.md](skills-guide.md) | répertoire des 155 skills |
