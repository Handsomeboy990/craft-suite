...
163 skills et 21 agents. Pas des prompts : des protocoles numérotés, des
...
├── engineering/     79 skills d'ingénierie
...
|---|---|---|
| Langue des skills | les instructions elles-mêmes | anglais, pour les 163 skills |
...
| Catégorie | Skills | Question à laquelle elle répond |
|---|---|---|
| [dev-skills](../engineering/dev-skills/) | 53 | comment une modification est faite correctement |
| [delivery-skills](../engineering/delivery-skills/) | 11 | quoi construire, dans quel ordre, avec quelle approbation |
| [devops-skills](../engineering/devops-skills/) | 15 | comment le système tourne, se déploie et se restaure |
...
```
   ...
   3) Software engineering    79 skills   plus 21 agents
   ...
   8) Everything             163 skills   plus 21 agents
...
bash install.sh --dev          les 79 skills d'ingénierie et les 21 agents
...
bash install.sh --agents        les 21 agents seulement
...
| `dev-skills` | 53 | engineering |
| `delivery-skills` | 11 | engineering |
| `devops-skills` | 15 | engineering |
...
| `craft-engineering` | l'arbre d'ingénierie, 79 skills et 21 agents |
...
```bash
bash tests/validate-structure.sh      structure et métadonnées des 163 skills
...
| [documentation/skills-guide.md](skills-guide.md) | répertoire des 163 skills |
