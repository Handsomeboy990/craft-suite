...
| `skills-guide.md` | directory of the 156 skills, inputs, outputs, table of choice by situation |
...
| `../docs/architecture/AGENT_ARCHITECTURE.md` | the layered architecture, the seventeen agents by group, the contract, safety |
