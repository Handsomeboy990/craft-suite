...
| `skills-guide.md` | directory of the 157 skills, inputs, outputs, table of choice by situation |
...
| `../docs/architecture/AGENT_ARCHITECTURE.md` | the layered architecture, the eighteen agents by group, the contract, safety |
