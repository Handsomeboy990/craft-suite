...
| `skills-guide.md` | directory of the 158 skills, inputs, outputs, table of choice by situation |
...
| `../docs/architecture/AGENT_ARCHITECTURE.md` | the layered architecture, the nineteen agents by group, the contract, safety |
